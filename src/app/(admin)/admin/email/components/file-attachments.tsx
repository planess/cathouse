...
import { AdminAdminEmailComponentsFileAttachmentsIcon01 } from '@app/components/icons/admin-admin-email-components-file-attachments-icon-01';
import { AdminAdminEmailComponentsFileAttachmentsIcon02 } from '@app/components/icons/admin-admin-email-components-file-attachments-icon-02';
          ...
          {files.map((file, index) => (
            ...
            >
              <div className="flex items-center gap-2 overflow-hidden">
                <AdminAdminEmailComponentsFileAttachmentsIcon01
              ...
              <button
                ...
                type="button"
              >
                <AdminAdminEmailComponentsFileAttachmentsIcon02
