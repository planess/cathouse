...
import { normalizeRoleDocument, type RawRoleDocument } from '@app/services/roles/normalize-role-document';
import { resolveRolePermissions } from '@app/services/roles/resolve-role-permissions';
...
export async function GET(_request: NextRequest) {
  ...
  try {
    ...
    const resolvedRoles = resolveRolePermissions(normalizedRoles);
