      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-slate-200 px-3 py-2 text-sm text-slate-900 focus:border-slate-900 dark:bg-stone-700 dark:text-stone-50 focus:outline-none focus:ring-2 focus:ring-slate-900/10 disabled:opacity-60 transition-colors"
