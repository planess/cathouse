        ...
        <div className="mt-4 grid gap-3 md:grid-cols-[1fr_minmax(0,160px)_minmax(0,200px)_auto]">
          ...
          <div className="flex items-end justify-end">
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 text-slate-600 hover:border-slate-900 hover:text-slate-900 disabled:opacity-60 dark:bg-zinc-500 dark:text-stone-50 transition-colors"
              aria-label={t('form.vaccinations_modal.add_button_label')}
              disabled={!hasClinicOptions}
            >
              <PlusIcon />
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-[1fr_minmax(0,160px)_minmax(0,200px)_auto]">
          ...
          <div className="flex items-end justify-end">
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 text-slate-600 transition-colors hover:border-slate-900 hover:text-slate-900 disabled:opacity-60 dark:bg-zinc-500 dark:text-stone-50"
              aria-label={t('form.vaccinations_modal.add_button_label')}
              disabled={!hasClinicOptions}
            >
              <PlusIcon />
