    ...
    <div className="px-6 py-7">
      <div className="flex flex-col lg:flex-row gap-y-6">
        <div className="flex-1/2 flex flex-col gap-6 grow-0 shrink-0 lg:pr-6">
          <div>
            <h1 className="text-3xl font-bold mb-4 dark:text-stone-50 transition-colors">{t('title')}</h1>

            <div className="text-zinc-800 dark:text-stone-50 transition-colors">{t('aboutus')}</div>
          </div>
