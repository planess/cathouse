...
function isImpactYearEmpty(report: ImpactYearReport) {
  return report.stats.yearSterilized === 0 && report.stats.yearLocations === 0;
}

function isFinanceYearEmpty(report: FinanceYearReport) {
  return report.finance.yearIncoming === 0 && report.finance.yearOutgoing === 0;
}
        ...
        {impactLoading ? (
          ...
          <div className="space-y-10">
            {impactYears.map((yearData, index) => {
              const isFoundationEmptyYear =
                yearData.year === FOUNDATION_START_YEAR &&
                isImpactYearEmpty(yearData);
              const isCurrentEmptyYear =
