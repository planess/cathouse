...
export default function Card({ data }: Props) {
  ...
  return (
    <div className="bg-[#f3f4f6] rounded-t-lg">
      <article className="group flex flex-col gap-6 rounded-lg border border-slate-100 bg-white p-5 shadow-[0_25px_80px_rgba(15,23,42,0.08)] transition hover:shadow-[0_35px_100px_rgba(15,23,42,0.12)] md:flex-row md:p-8">
